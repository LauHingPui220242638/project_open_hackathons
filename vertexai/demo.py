...
def LLM_init():
    ...
    If you cannot find the coordinates, return 'I dont know'.
    {chat_history}
        Human: {human_input}
        Chatbot:"""
...
def ferry_agent():
    ...
    result = agent.run('Please list and describe coordinates of 10 ferry stops.')
    return result

agent_ferry = ferry_agent()
#data_dict = json.loads(agent_ferry)
